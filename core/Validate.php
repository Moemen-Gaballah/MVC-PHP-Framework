	...
	public function displayErrors() {
		...
		foreach ($this->_errors as $error) {
			if(is_array($error)) {
				...
				$html.='<script>jQuery("document").ready(function(){jQuery("#'.$error[1].'").parent().colsest("div").addClass("has-error");});</script>';
			} else {
